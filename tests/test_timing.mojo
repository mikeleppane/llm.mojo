...
#
# These are pure math, independent of any clock, so they get hand-computed
# oracles: the median of a known list (odd and even counts, unsorted input) and
# a GFLOP/s figure worked out by hand.
