...
Reference math is `Float64` with tight tolerances (`1e-9`–`1e-12`); `Float32`
...
Dependencies flow in one direction only — lower layers never import higher
ones:
...
- Sebastian Raschka's *Build a Large Language Model (From Scratch)* — kindred
